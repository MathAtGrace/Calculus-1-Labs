...
Materials needed: tape measure and nerf gun.
	...
	\begin{questions}
		...
		\uplevel{For the following two problems, make sure to document your methods of measurement.  Your general principle should be that anything that might cause you to have a different answer than another group should be well documented and explained.}
